...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { Email: @register.Email, First: @register.First, Last: @register.Last, Name: @register.Name, Password: @register.Password, Phone: @register.Phone, Zip: @register.Zip } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { Email: @register.Email, First: @register.First, Last: @register.Last, Name: @register.Name, Password: @register.Password, Phone: @register.Phone, Zip: @register.Zip } }
